...
class CustomEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Dict({"planted": spaces.Discrete(2),
    ...
    def gameover(self):
        ...
        return {"planted": int(self.planted), "harvested": int(self.harvested),
                "continuous": observation}, 0.0, True, {}
    ...
    def step(self, action):
        ...
        if action == 2: # harvest
            ...
            observation = [float(self.day_of_year), float(self.crop_height)]
            observation = np.array(observation, dtype=np.float32)
            observation = {"planted": int(self.planted), "harvested": int(self.harvested), "continuous": observation}
