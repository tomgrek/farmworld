...
if __name__ == "__main__":
    ...
    model = DQN("MultiInputPolicy", env, verbose=1, exploration_initial_eps=0.15,
                exploration_fraction=0.5, gradient_steps=-1,
                train_freq=4, learning_starts=100,
                target_update_interval=2000, gamma=0.995)
